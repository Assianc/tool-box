...
async def handle_message(event):
    ...
    if user is not None:
        keys_to_print = ["id", "username", "name", "last_posted_at", "last_seen_at", "created_at", "ignored", "muted", "can_ignore_user", "can_mute_user", "can_send_private_messages", "can_send_private_message_to_user", "trust_level", "moderator", "admin", "badge_count", "time_read", "recent_time_read", "primary_group_id", "primary_group_name", "flair_group_id", "featured_topic", "timezone", "can_edit", "can_edit_username", "can_edit_email", "can_edit_name", "pending_count", "profile_view_count", "can_upload_profile_header", "can_upload_user_card_background", "custom_avatar_upload_id", "can_chat_user", "can_see_following", "can_see_followers", "can_see_network_tab", "can_follow", "is_followed", "total_followers", "total_following", "notify_me_when_followed", "notify_followed_user_when_followed", "notify_me_when_followed_replies", "notify_me_when_followed_creates_topic", "allow_people_to_follow_me", "gamification_score", "vote_count", "see_signatures", "accepted_answers", "featured_user_badge_ids"]
        chinese_keys = ["ID", "用户名", "名称", "最后发帖时间", "最后在线时间", "创建时间", "忽略", "静音", "可以忽略用户", "可以静音用户", "可以发送私人消息", "可以向用户发送私人消息", "信任等级", "版主", "管理员", "徽章数量", "阅读时间", "最近阅读时间", "主要组ID", "主要组名称", "标签组ID", "特色主题", "时区", "可以编辑", "可以编辑用户名", "可以编辑电子邮件", "可以编辑名称", "待处理数量", "个人资料查看次数", "可以上传个人资料头部", "可以上传用户卡背景", "自定义头像上传ID", "可以与用户聊天", "可以查看关注者", "可以查看粉丝", "可以查看网络标签", "可以关注", "被关注", "总粉丝数", "总关注数", "当被关注时通知我", "当被关注的用户被关注时通知我", "当被关注的用户回复时通知我", "当被关注的用户创建主题时通知我", "允许人们关注我", "游戏化分数", "投票数", "查看签名", "接受的答案", "特色用户徽章ID"]
